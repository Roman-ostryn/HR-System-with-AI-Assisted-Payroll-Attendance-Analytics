...
// import { getVistaCalandra } from "../../services/reporteCalandra.services";
import { getVistaSalaLimpia } from "../../services/reporteSalaLimpia.services";
// import ModalProblemaLavadora from "../../modal/problema/modalProblemaLavadora";
import ModalProblema from "../../modal/problema/modalProblemaSLC"; // Importa el modal
import io from 'socket.io-client';
import ModalEditSalaL from "../../modal/problema/modalEditSalaL";
...
const ReporteCalandra = () => {
  ...
  const fetchPrueba = async () => {
    try {
      const response = await getVistaSalaLimpia();
      setData(response);
  ...
  const columns = [
    ...
    { field: "entroproblema", headerName: "Llego con Problemas?", flex: 0.6 },
    {
      field: "imagenes",
      headerName: "Imágenes",
      flex: 0.5,
  ...
  return (
    <Box m="20px">
      <Box display="flex" justifyContent="space-between" p={0}>
        <Header
          title="Reporte "
          subtitle="Problemas Sala Limpia->Calandra"
        />

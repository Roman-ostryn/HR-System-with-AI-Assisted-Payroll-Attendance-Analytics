...
import {getOneChapasHistorial} from "../../services/pedidoVenta.services"
...
const ModalChapas = ({ open, onClose, registro }) => {
  console.log("🚀 ~ ModalChapas ~ registro:", registro)
  ...
  const fetchOrdenProduccion = async () => {
    try {
      console.log("🚀 ~ fetchOrdenProduccion ~ registro:", registro)

      const response = await getOneChapasHistorial(registro?.id);

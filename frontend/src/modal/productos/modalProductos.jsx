  ...
  const ModalProductos = ({ open, onClose, onSelectProduct }) => {
    ...
    useEffect(() => {
      ...
      const fetchProductos = async () => {
        try {
          const response = await getDatosProducto();
    ...
    const handleRowClick = (params) => {
      ...
      onSelectProduct(selectedUser); // Envía los datos del usuario seleccionado

  ...
  import { getDatosClasificacion } from '../../services/clasificacion.services'; // Asegúrate de tener este servicio

  const ModalClasificacion = ({ open, onClose, onSelect }) => {
    ...
    useEffect(() => {
      ...
      const fetchProductos = async () => {
        try {
          const response = await getDatosClasificacion();
        ...
        >
          <Box m="0px">
            <Box display="flex" justifyContent="space-between" p={2} >
              <h1 id="owner-modal-title">Buscar Clasificacion</h1>
              <Box
                display="flex"

...
import '../css/Logout.scss'; // Asumiendo que tu CSS personalizado está en este archivo
// import Logout  from "../../modal/Logout";
const Logout = ({isLoading, onClose}) => {
  ...
  <button className="logoutButton logoutButton--dark">
    <svg className="doorway xd-svg" viewBox="0 0 100 100">
    ...
    <svg className="figure xd-svg" viewBox="0 0 100 100">
    ...
    <svg className="door xd-svg" viewBox="0 0 100 100">
      <path d="M93.4 86.3H58.6c-1.9 0-3.4-1.5-3.4-3.4V17.1c0-1.9 1.5-3.4 3.4-3.4h34.8c1.9 0 3.4 1.5 3.4 3.4v65.8c0 1.9-1.5 3.4-3.4 3.4z" />

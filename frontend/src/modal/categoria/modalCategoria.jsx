  ...
  import { getDatosCategoria } from '../../services/productos.services'; // Asegúrate de tener este servicio
  // import { getDatosCategoria } from '../../services/Categoria.services'; // Asegúrate de tener este servicio

  const ModalCategoria = ({ open, onClose, onSelect }) => {
    ...
    useEffect(() => {
      ...
      const fetchProductos = async () => {
        try {
          const response = await getDatosCategoria();
        ...
        >
          <Box m="0px">
            <Box display="flex" justifyContent="space-between" p={2} >
              <h1 id="owner-modal-title">Buscar Categoria</h1>
              <Box
                display="flex"

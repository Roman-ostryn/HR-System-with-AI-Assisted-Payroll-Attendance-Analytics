  ...
  import { getDatosHorarios } from '../../services/horarios.services'; // Asegúrate de tener este servicio

  const ModalHorario = ({ open, onClose, onSelectHorario }) => {
    ...
    const handleRowDoubleClick = (params) => {
      ...
      onSelectHorario({ id}); // Envía el salario seleccionado

...
const postDatosAprovechamiento = async (data) => {
  try {
    const response = await api.post('aprovechamiento', data);
...
export { postDatosAprovechamiento, PostDatosProductos, getOneDatos };
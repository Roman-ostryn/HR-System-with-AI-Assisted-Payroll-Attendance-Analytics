...
const Pagos = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    setIsLoading(true);
    //console.log("Valores a cargar en la base de datos:------------------>", values);
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              {/* <TextField
                ...
                InputProps={{
                  readOnly: false, // Solo se puede seleccionar mediante el modal
                }}
              /> */}
              ...
              {/* <TextField
                ...
                name="descuento"
                error={!!touched.descuento && !!errors.descuento}
...
const checkoutSchema = yup.object().shape({
  ...
  // descuento: yup.string().required("Este Campo es Requerida"),
  // cedula: yup.string().required("Este Campo es Requerida"),
  // dias: yup.number().required("Este Campo es Requerida"),
  // estado: yup.string().required("Este Campo es Requerida"),

...
import { PostDatosSalarios } from "../../services/salarios.services";
...
const Salarios = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await PostDatosSalarios(valuesToSend);
  ...
  return (
    <Box m="20px">
      <Header title="Registro Salario" subtitle="Registro Salario" />

...
import { insertData} from "../services/plus/Insert.services";
...
import Plus from "../interface/plus";


export const createPlus = async (req: Request, res: Response) => {
  const tableName = "plus"; // Reemplaza con el nombre de tu tabla
  const data: Plus = req.body;
...
export const getPlus = async (req: Request, res: Response) => {
  const tableName = "plus"; // Reemplaza con el nombre de tu tabla
